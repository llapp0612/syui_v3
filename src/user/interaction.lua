...
if (package_path_native == nil) then
    ...
    --package.path = package.path .. ';./mods/syui/?.lua;./mods/?.lua;./mods/?/init.lua;./data/?.lua;./data/?/init.lua';
...
function game:TargetsTarget()
    if(not sy_ui.exist())then return end
    sy_ui.TargetsTarget()
end

function game:tt_to_target()
    if(not sy_ui.exist())then return end
    sy_ui.tt_to_target()
end

function game:tt_bar()
    if(not sy_ui.exist())then return end
    sy_ui.tt_bar()
end
